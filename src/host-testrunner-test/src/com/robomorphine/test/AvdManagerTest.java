...
public class AvdManagerTest extends TestCase {
    ...
    public void testCreateAvd() throws AndroidLocationException {
        ...
        ISdkLog sdkLog = new ISdkLog2ILog(logger);
        SdkManager sdkManager = SdkManager.createManager(path.getAbsolutePath(), sdkLog);
                
        AvdManager avdManager = new AvdManager(sdkManager, logger);
